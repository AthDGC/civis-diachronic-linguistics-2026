...
2. {sections_text}
3. Evidence: Quote specific passages from student text where relevant
4. Actionable Feedback: Specific suggestions for improvement
5. {lang_inst}
6. {person_inst}
7. Write in a natural, flowing academic style - avoid mechanical formatting
...
EXAMPLES:
  ...
  python lavidas_evaluator.py ./essays --person singular --model claude
  python lavidas_evaluator.py ./essays --model perplexity --output results.txt
""")
            return
